...
# time series of abundance as catch/standard tow
# output of survey model grouped on year, area, season
# calculated average observed and predicted of each size class
survey<-read_csv(str_c(mills_path,"Projects/NSF_CAccel/Data/atlantic_cod2060.csv"),col_types=cols())
