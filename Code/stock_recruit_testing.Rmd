...
Average age class landings for each region and season are stored in the features with n = 3 year lags. Adjusting those values will need to take place before the lags are made.

Scenarios:   
 * Doubling or halving nlarge biomass at a given 1-3 year period   
 * Similar test, but for one region   
 * And again for a given season
...
## 4. Strata Plots {.tabset .tabset-pills}
